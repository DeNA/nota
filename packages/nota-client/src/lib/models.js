export const Task = {
  ...
  MIN_ASSIGNMENT_SIZE: 1,
  DEFAULT_ASSIGNMENT_SIZE: 100
};
Task.DEFAULT_ASSIGNMENT_ORDER = Task.ASSIGNMENT_ORDER.RANDOM;
Task.ASSIGNMENT_ORDER_TEXT = {
  [Task.ASSIGNMENT_ORDER.RANDOM]: "random",
  [Task.ASSIGNMENT_ORDER.SEQUENTIAL]: "in-order"
};
Task.STATUS_TEXT = {
